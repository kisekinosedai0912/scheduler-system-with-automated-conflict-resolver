<x-app-layout>
    ...
    <div class="outer-container flex flex-col md:flex-row items-center justify-between">
        <div class="flex items-center relative md:w-3/12 my-2">
            ...
            <input type="search" placeholder="search subject" class="w-full h-10 pl-10 pr-4 px-1.5 text-gray-900 bg-white focus:outline-none focus:bg-[#223a5e] transition duration-300">
        </div>
